...
export interface InputHandlers {
  /** A click that wasn't a drag — select whatever is at this world point. */
  onPick(world: Point): void;
  /** Pointer moved (world coords) — used for hover highlighting. */
  onHover(world: Point): void;
  /** The camera changed (pan/zoom) — the app may want to mark view dirty. */
  onCameraChange(): void;
}
